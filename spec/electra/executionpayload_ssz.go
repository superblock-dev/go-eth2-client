...
func (e *ExecutionPayload) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(e.WithdrawalRequests); size > 16 {
		err = ssz.ErrListTooBigFn("ExecutionPayload.WithdrawalRequests", size, 16)
		return
	}
...
func (e *ExecutionPayload) UnmarshalSSZ(buf []byte) error {
	...
	// Field (12) 'BlockHash'
	copy(e.BlockHash[:], buf[696:728])

	// Offset (13) 'Transactions'
	if o13 = ssz.ReadOffset(buf[728:732]); o13 > size || o10 > o13 {
		return ssz.ErrOffset
	}

	// Offset (14) 'Withdrawals'
	if o14 = ssz.ReadOffset(buf[732:736]); o14 > size || o13 > o14 {
		return ssz.ErrOffset
	}

	// Field (15) 'BlobGasUsed'
	e.BlobGasUsed = ssz.UnmarshallUint64(buf[736:744])

	// Field (16) 'ExcessBlobGas'
	e.ExcessBlobGas = ssz.UnmarshallUint64(buf[744:752])

	// Offset (17) 'DepositRequests'
	if o17 = ssz.ReadOffset(buf[752:756]); o17 > size || o14 > o17 {
		return ssz.ErrOffset
	}

	// Offset (18) 'WithdrawalRequests'
	if o18 = ssz.ReadOffset(buf[756:760]); o18 > size || o17 > o18 {
		return ssz.ErrOffset
	}
