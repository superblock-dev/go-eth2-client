...
// Hash: 12c2d73851bd423741162bf1691e841a63b70958a594ae7fc755e97e5290aede
// Version: 0.1.4
package electra
...
func (b *BeaconState) UnmarshalSSZ(buf []byte) error {
	...
	// Field (28) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = capella.WithdrawalIndex(ssz.UnmarshallUint64(buf[2736657:2736665]))

	// Field (29) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = phase0.ValidatorIndex(ssz.UnmarshallUint64(buf[2736665:2736673]))
	...
	// Field (32) 'DepositBalanceToConsume'
	b.DepositBalanceToConsume = phase0.Gwei(ssz.UnmarshallUint64(buf[2736685:2736693]))

	// Field (33) 'ExitBalanceToConsume'
	b.ExitBalanceToConsume = phase0.Gwei(ssz.UnmarshallUint64(buf[2736693:2736701]))

	// Field (34) 'EarliestExitEpoch'
	b.EarliestExitEpoch = phase0.Epoch(ssz.UnmarshallUint64(buf[2736701:2736709]))

	// Field (35) 'ConsolidationBalanceToConsume'
	b.ConsolidationBalanceToConsume = phase0.Gwei(ssz.UnmarshallUint64(buf[2736709:2736717]))

	// Field (36) 'EarliestConsolidationEpoch'
	b.EarliestConsolidationEpoch = phase0.Epoch(ssz.UnmarshallUint64(buf[2736717:2736725]))
