...
func (e *ExecutionPayloadHeader) UnmarshalSSZ(buf []byte) error {
	...
	// Field (13) 'TransactionsRoot'
	copy(e.TransactionsRoot[:], buf[728:760])

	// Field (14) 'WithdrawalsRoot'
	copy(e.WithdrawalsRoot[:], buf[760:792])

	// Field (15) 'BlobGasUsed'
	e.BlobGasUsed = ssz.UnmarshallUint64(buf[792:800])

	// Field (16) 'ExcessBlobGas'
	e.ExcessBlobGas = ssz.UnmarshallUint64(buf[800:808])

	// Field (17) 'DepositRequestsRoot'
	copy(e.DepositRequestsRoot[:], buf[808:840])

	// Field (18) 'WithdrawalRequestsRoot'
	copy(e.WithdrawalRequestsRoot[:], buf[840:872])
